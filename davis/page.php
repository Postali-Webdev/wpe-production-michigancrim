...
<link rel="preload" as="image" href="<?php echo checkWebpCompatibility($title_image); ?>">
	<?php get_header(); ?>
		<?php if(!get_post_meta($id, "qode_show-page-title", true)) { ?>
			<div class="banner-img title animate <?php if($content_animation == 'no'){ echo 'no_entering_animation '; } if($responsive_title_image == 'no' && $title_image != "" && $fixed_title_image == "yes"){ echo 'has_fixed_background '; } if($responsive_title_image == 'no' && $title_image != "" && $fixed_title_image == "no"){ echo 'has_background'; } if($responsive_title_image == 'yes'){ echo 'with_image'; } ?>" <?php if($responsive_title_image == 'no' && $title_image != ""){ echo 'style="background-image:url('.checkWebpCompatibility($title_image).'); height:'.$title_height.'px;"'; }?>>
			...
			<div class="container_inner">
				...
				<?php if(($sidebar == "default")||($sidebar == "")) : ?>
					<?php if (have_posts()) : 
							...
							<h1><?php the_title(); ?></h1>
                            <?php if ( function_exists('yoast_breadcrumb') ) {yoast_breadcrumb('<p id="breadcrumbs">','</span></span></p>');} ?>
							<?php the_content(); ?>		
							<?php endwhile; ?>
						<?php endif; ?>
