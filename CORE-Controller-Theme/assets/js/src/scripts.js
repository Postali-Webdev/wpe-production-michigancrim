...
jQuery( function ( $ ) {
    ...
    $('#menu-main-menu > li.menu-item-has-children').prepend('<div class="accordion-toggle"><span class="icon-chevron_right"></span></div>');
    ...
    $('#menu-main-menu > li.menu-item-has-children > .sub-menu > li.menu-item-has-children').prepend('<div class="accordion-toggle2"><span class="icon-chevron_right"></span></div>');
