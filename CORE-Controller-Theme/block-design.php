<?php 
    ...
    // banner styles
    $include_gradient = get_field('include_gradient_overlay','options');
...
<style type="text/css">  
    ...
    .sidebar-block .sidebar-header { color: white; background: <?php echo $color_secondary_2; ?>; font-family: <?php echo $GLOBALS['font_paragraph']; ?>; }
